              ...
              <div className="glass-panel flex-1 flex flex-col relative" style={{borderRadius: '0 0 18px 18px', overflow: 'visible'}}>
                  ...
                  <div className="absolute top-2 left-2 right-2 z-10">
                    <div className="glass-panel neon-border p-2 relative">
                      <img src={airdropPackage} alt="Gift Package" className="h-44 w-44 absolute right-[8px] top-[-95px] z-[9999]" style={{filter: 'drop-shadow(0 0 2px rgba(0, 0, 0, 0.9)) drop-shadow(0 0 4px rgba(0, 0, 0, 0.7))'}} data-testid="img-gift-package" />
