        ...
        <div className="flex-1 flex" style={{overflow: 'visible'}}>
          ...
          {!isChatCollapsed && (
            <div className="flex flex-col flex-1" style={{width: '345px', marginTop: '0px'}}>
              {/* Degen Chat Header */}
              <div className="glass-panel p-3 flex items-center justify-between" style={{borderRadius: '0 0 0 0'}}>
              ...
              {/* Chat Box Container */}
              <div className="glass-panel flex-1 flex flex-col relative" style={{borderRadius: '0 0 0 0', overflow: 'hidden'}}>
        ...
        <div className="flex-1 flex flex-col overflow-hidden relative">
          ...
          <div className="flex-shrink-0 transition-all duration-300 relative glass-panel" style={{
            ...
            <button
              ...
              className="absolute top-1/2 -translate-y-1/2 flex items-center justify-center hover-elevate active-elevate-2 transition-all duration-300"
              style={{
                right: isLeaderboardCollapsed ? '77px' : 'calc(100% - 318px)',
                zIndex: 9999,
