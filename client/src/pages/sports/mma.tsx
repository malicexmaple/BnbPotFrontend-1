...
export default function MMA() {
  ...
  const mmaMarkets = allMarkets?.filter(m => m.league === 'UFC' || m.league === 'MMA') || [];
  const games = groupMarketsByGame(mmaMarkets);
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <h2 className="text-3xl font-bold text-foreground font-sohne">
                UFC <span className="text-primary ml-1">FIGHTS</span>
              </h2>
            </div>
            ...
            {marketsError && (
              <Alert variant="destructive">
                ...
                <AlertDescription>Failed to load fights. Please try again later.</AlertDescription>
              </Alert>
            )}
            ...
            {marketsLoading ? (
              ...
              <div className="text-center py-12 bg-card rounded-lg border border-card-border">
                <p className="text-muted-foreground text-lg">No active UFC fights</p>
