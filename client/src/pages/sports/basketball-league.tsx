// Basketball League Matches Page - Shows matches for a specific league
...
export default function BasketballLeague() {
  const { isAuthenticated, isLoading: authLoading } = useAuth();
  const [, params] = useRoute("/sports/basketball/league/:leagueName");
  ...
  const sportConfig = sportsData.find(s => s.id === 'basketball');
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto bg-background relative">
        ...
        <div className="mb-8">
          <Button
            variant="ghost"
            onClick={() => setLocation("/sports/basketball/leagues")}
            className="mb-4"
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <h1 className="text-4xl font-bold text-foreground">{leagueName}</h1>
          </div>
