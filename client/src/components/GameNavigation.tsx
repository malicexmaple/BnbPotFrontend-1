...
export default function GameNavigation({ 
  ...
  return (
    <nav className="sticky top-0 z-50 bg-black flex items-center border-b border-border/20" style={{height: '100px'}}>
      ...
      <div className="flex-1 flex flex-col justify-center px-4" style={{paddingTop: '2px'}}>
        ...
        <div className="flex items-center justify-between" style={{marginTop: '-16px'}}>
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-3 px-4 rounded-lg" style={{
              ...
              <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" style={{color: '#EAB308'}}>
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
              </svg>
              <div className="flex flex-col items-center justify-center">
                <span className="font-bold gradient-text italic leading-tight" style={{fontSize: '13px'}}>$25K WEEKLY</span>
                <span className="text-muted-foreground leading-tight" style={{fontSize: '13px'}}>LEADERBOARD</span>
              </div>
            </div>
