...
export default function GameNavigation({ 
  ...
  return (
    <div className="flex w-full" style={{height: '100px', display: 'flex'}}>
      {/* Left - Logo box. Uses the same dark glass strip styling as the
          bottom JACKPOT/COINFLIP nav, but stretched across the full 100px
          height of the header (no separate top strip, no inner box). */}
      <div
      ...
      >
        ...
        <div className="shine-image" style={{'--shine-mask': `url(${textLogo})`, marginLeft: '-6px'} as React.CSSProperties}>
          <img src={textLogo} alt="BNBPOT" style={{ height: '40px', width: 'auto', display: 'block' }} />
        </div>
      </div>
        ...
        <nav className="flex flex-nowrap items-center justify-between px-2 sm:px-4" style={{
          ...
          <Link href="/" onClick={(e) => { if (activeTab === "jackpot") e.preventDefault(); }}>
            <Button
              ...
              variant="ghost"
              className="px-2 sm:px-4 h-10 sm:h-12"
              style={{
                borderRadius: '10px',
                background: activeTab === "jackpot" ? 'rgba(30, 30, 30, 0.9)' : 'rgba(20, 20, 20, 0.7)',
          ...
          <Link href="/coinflip" onClick={(e) => { if (activeTab === "coinflip") e.preventDefault(); }}>
            <Button
              ...
              style={{
                borderRadius: '10px',
                background: activeTab === "coinflip" ? 'rgba(30, 30, 30, 0.9)' : 'rgba(20, 20, 20, 0.7)',
                border: '1px solid rgba(60, 60, 60, 0.4)',
                boxShadow: 'inset 0 1px 0 rgba(255, 255, 255, 0.05), 0 2px 8px rgba(0, 0, 0, 0.5)'
              }}
            >
          ...
          <Link href="/prediction-markets" onClick={(e) => { if (activeTab === "prediction-markets") e.preventDefault(); }}>
            <Button
              ...
              style={{
                borderRadius: '10px',
                background: activeTab === "prediction-markets" ? 'rgba(30, 30, 30, 0.9)' : 'rgba(20, 20, 20, 0.7)',
                border: '1px solid rgba(60, 60, 60, 0.4)',
                boxShadow: 'inset 0 1px 0 rgba(255, 255, 255, 0.05), 0 2px 8px rgba(0, 0, 0, 0.5)'
              }}
            >
            ...
            {isConnected && username ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 bg-card border-border/40">
                  ...
                  <DropdownMenuItem asChild className="px-3 py-2.5 cursor-pointer" data-testid="menu-leaderboard">
                    <Link href="/leaderboard">
                      <Award className="mr-3 text-muted-foreground" style={{width: '18px', height: '18px'}} />
